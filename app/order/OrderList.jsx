...
export default function OrderList() {
  ...
  return (
    <>
   <Link href='/order/1'>
      <h1 className="text-base md:text-lg text-black font-semibold px-4 md:px-6 py-4">Recent  Orders</h1>
            ...
            <table className="w-full text-left min-w-full">
              <thead className="bg-gray-100 border-b">
                <tr>
                  ...
                  <th className="p-3 md:p-4 font-medium">Order Name</th>
                  <th className="p-3 md:p-4 font-medium">Order id</th>
                  <th className="p-3 md:p-4 font-medium">castomername</th>
                  <th className="p-3 md:p-4 font-medium">Payment Method</th>
                  ...
                  <th className="p-3 md:p-4 font-medium">action</th>
              ...
              <tbody>
                {orders.map((o, index) => (
                  <tr key={index} className="border-b hover:bg-gray-50 transition-colors">
                    ...
                    <td className="p-3 md:p-4 font-medium">{o.orderId}</td>
                    ...
                    <td className="p-3 md:p-4 text-gray-600">{o.payment}</td>
